...
public sealed class CreateBonLivraisonClientLigneDtoValidator : AbstractValidator<CreateBonLivraisonClientLigneDto>
{
    public CreateBonLivraisonClientLigneDtoValidator()
    {
        ...
        RuleFor(x => x.QuantiteLivree)
            .GreaterThan(0).WithMessage("La quantité livrée doit être supérieure à zéro.");
